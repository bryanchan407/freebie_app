...
class _LoginState extends State<Login> {
  ...
  Future signInWithGoogle() async {
    ...
    if (user != null) {
      if (widget.box.get(user.email) == null) {
        Account acc = Account(
            email: user.email,
            name: user.displayName!,
            id: user.id,
            events: []);
        widget.box.put(user.email, acc);
      }
      Navigator.of(context).pushReplacement(MaterialPageRoute(
          builder: (context) => Dashboard(user: widget.box.get(user.email))));
    } else {
            ...
            child: ListView(
              children: <Widget>[
                ...
                OutlinedButton(
                    ...
                    onPressed: () {
                      if (widget.box.get(emailController.text) != null) {
                        if (widget.box.get(emailController.text).password ==
                            pwController.text) {
