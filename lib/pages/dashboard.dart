              ...
              child: Column(
                children: <Widget>[
                  ...
                  TextFormField(
                    ...
                    onChanged: (String value) => _eventName = value,
                  ...
                  ElevatedButton(
                      ...
                      style:
                          ElevatedButton.styleFrom(primary: Color(0xff99cae1))),
                  Padding(padding: EdgeInsets.symmetric(vertical: paddingSize)),
                  TextFormField(
                    textCapitalization: TextCapitalization.words,
                    decoration: const InputDecoration(
                    ...
                    onChanged: (String? value) async {
                      ...
                      setState(() {
                        _coordinates = LatLng(locations.first.latitude,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: Color(0xff99cae1),
      ),
