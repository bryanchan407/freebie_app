...
class FreebieDash extends StatefulWidget {
  ...
  @override
  State<FreebieDash> createState() => FreebieDashState();
}

class FreebieDashState extends State<FreebieDash> {
...
// Determine the current position of the device.
  ...
  Future addMarkers() async {
    ...
    final Iterable<Event> _list = widget.box.values.cast();
    for (Event e in _list) {
      if (e.timeEnding.isAfter(DateTime.now()) && e.rsvpee == null) {
        ...
        Marker placeholder = Marker(
            ...
            icon: (e.userEmail == widget.user.email)
